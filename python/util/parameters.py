...
def load_parameters():
    FIXED_PARAMETERS = {
        ...
        "training_mnli": "{}/multinli_0.2/multinli_0.2_train.jsonl".format(args.datapath),
        "dev_matched": "{}/multinli_0.2/multinli_0.2_dev_matched.jsonl".format(args.datapath),
        "dev_mismatched": "{}/multinli_0.2/multinli_0.2_dev_mismatched.jsonl".format(args.datapath),
        "test_matched": "{}/multinli_0.2/multinli_0.2_test_matched.jsonl".format(args.datapath),
        "test_mismatched": "{}/multinli_0.2/multinli_0.2_test_mismatched.jsonl".format(args.datapath),
