...
if not os.path.isfile(dictpath): 
    ...
    indices_to_words, word_indices = sentences_to_padded_index_sequences([training_data], [dev_matched, dev_mismatched, dev_snli, test_snli, test_matched, test_mismatched])
